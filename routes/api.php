...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function() {
    Route::get('bzslider', 'App\Http\Controllers\Api\V2\SliderController@bzslider');
    Route::get('bigzloot', 'App\Http\Controllers\Api\V2\DiscountShopController@index');
    Route::get('bigzloot/{id}', 'App\Http\Controllers\Api\V2\DiscountShopController@bigzlootShop');
