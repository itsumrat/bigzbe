...
use App\Http\Controllers\BigzlootController;
 ...
 */
//bigzloot
Route::controller(BigzlootController::class)->group(function () {
    //mobile app balnk page for webview
    Route::get('/bigzloot', 'index')->name('bigzloot');
    Route::get('/bigzloot/action', 'action')->name('bigzloot.action');
    Route::post('/bigzloot/shopfetch', 'shopfetch')->name('bigzloot.shopfetch');
    Route::get('/bigzlootshop/create', 'bigzlootShopCreate')->name('bigzlootShop.create');
    Route::post('/bigzlootshop/store', 'bigzlootShopStore')->name('bigzlootShop.store');

    Route::get('/shop/bigzloot/single', 'bigzlootShop')->name('bigzlootShop');
    Route::get('/bigzloot/{slug}', 'bigzlootShop')->name('bzshop.visit');
    Route::get('/bigzloot/{slug}/{type}', 'bz_filter_shop')->name('bzshop.visit.type');
});
...
Route::controller(HomeController::class)->group(function () {
    ...
    //bigzloot imran
    Route::post('/home/section/best_discounted_sellers', 'load_best_discounted_sellers_section')->name('home.section.best_discounted_sellers');
    ...
    Route::post('/shop/schedule', 'shop_schedule')->name('seller.shop.schedule');
