...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
            ...
            //bigzloot Sliders
    Route::controller(BzSliderController::class)->group(function () {
        Route::get('/bzslider','index')->name('bzslider');
        Route::get('/bzslider/create','create')->name('bzslider.create');
        Route::post('/bzslider/dtore','store')->name('bzslider.store');
        Route::get('/bzslider/edit/{id}','edit')->name('bzslider.edit');
        Route::post('/bzslider/update','update')->name('bzslider.update');
        Route::get('/bzslider/destroy/{id}', 'destroy')->name('bzslider.destroy');
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        Route::get('/products/offline-all', 'all_offline_products')->name('products.alloffline');
    ...
    Route::controller(SellerController::class)->group(function () {
        Route::get('/offline-sellers', 'offlineSeller_index')->name('sellers.offline');
