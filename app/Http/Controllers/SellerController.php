...
class SellerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $shops = Shop::whereIn('user_id', function ($query) {
                    ...
                    })->where('is_discounted',null)->latest();
//imran
...
//Offline Seller Imran
   public function offlineSeller_index(Request $request)
    {
        $sort_search = null;
        $approved = null;
        $shops = Shop::whereIn('user_id', function ($query) {
        ...
        $shops = $shops->paginate(15);
        return view('backend.sellers.offlineindex', compact('shops', 'sort_search', 'approved'));
    }
