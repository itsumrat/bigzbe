            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        @else
                          <input type="hidden" class="form-control aiz-date-range" name="date_range" placeholder="{{translate('Select Date')}}" data-time-picker="true" data-format="DD-MM-Y HH:mm:ss" data-separator=" to " autocomplete="off">
                        @endif
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        @else
                        <div class="col-md-6">
                            <input type="hidden"value="0" name="discount" class="form-control" >
                        </div>
                    @endif
                    </div>
