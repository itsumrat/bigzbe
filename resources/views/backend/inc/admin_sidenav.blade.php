                ...
                @canany(['add_new_product', 'show_all_products','show_in_house_products','show_seller_products','show_digital_products','product_bulk_import','product_bulk_export','view_product_categories', 'view_all_brands','view_product_attributes','view_colors','view_product_reviews'])
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('show_all_products')
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('products.alloffline')}}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('All Offline Products') }}</span>
                                    </a>
                                </li>
                            @endcan
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                @php
                                    $sellers = \App\Models\Shop::where('verification_status', 0)->where('verification_info', '!=', null)->count();
                                @endphp
                                <a href="{{ route('sellers.offline') }}" class="aiz-side-nav-link {{ areActiveRoutes(['sellers.offline', 'sellers.create', 'sellers.edit', 'sellers.payment_history','sellers.approved','sellers.profile_modal','sellers.show_verification_request'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('Offline Seller') }}</span>
                                    @if($sellers > 0)<span class="badge badge-info">{{ $sellers }}</span> @endif
                                </a>
                            </li>
                             @endcan
                ...
                @canany(['header_setup','footer_setup','view_all_website_pages','website_appearance'])
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('website_appearance')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('bzslider') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{translate('Bigzloot Sliders')}}</span>
                                    </a>
                                </li>
                            @endcan
                        </ul>
