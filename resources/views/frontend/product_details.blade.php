                    ...
                    <div class="bg-white rounded shadow-sm">
                        <div class="border-bottom p-3">
                            <h3 class="fs-16 fw-600 mb-0">
                                <span class="mr-4">{{ translate('Related prooducts')}}</span>
                            </h3>
                        </div>
                        <div class="p-3">
                            ...
                            @foreach (filter_products(\App\Models\Product::whereNotIn('user_id',$discounted_seller_ids )->where('category_id', $detailedProduct->category_id)->where('id', '!=', $detailedProduct->id))->limit(10)->get() as $key => $related_product)
