...
@section('content')
    ...
    {{-- Best Discounted Seller --}}
    <div id="section_best_discounted_sellers">
...
@section('script')
    <script>
        $(document).ready(function(){
            ...
            $.post('{{ route('home.section.best_discounted_sellers') }}', {_token:'{{ csrf_token() }}'}, function(data){
                $('#section_best_discounted_sellers').html(data);
                AIZ.plugins.slickCarousel();
            });
        });
    </script>
