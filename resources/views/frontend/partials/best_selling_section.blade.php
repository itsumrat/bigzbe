...
$discounted_seller_ids = \App\Models\Shop::where('is_discounted',1)->pluck('user_id');
    ...
    $best_selling_products = Cache::remember('best_selling_products', 86400, function () use ($discounted_seller_ids) {
        return filter_products(\App\Models\Product::whereNotIn('user_id',$discounted_seller_ids )->where('published', 1)->orderBy('num_of_sale', 'desc'))->limit(20)->get();
    });   
@endphp
